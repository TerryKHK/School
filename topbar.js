...
class Topbar extends Component {
  ...
  render() {
    ...
    const dash = <TopLink link='/' iconClass='fas fa-tachometer-alt' text="Dashboaard" ttPosition="bottom" />;
    ...
    return(
      <nav className="navbar navbar-default navbar-static-top" role="navigation" style={{marginBottom: 0}}>
        <div className="navbar-header">
          <a className="navbar-brand" href="/"><span><img src={globalState.logoUrl} height={35} className="brand-img-align" alt={globalState.name} /></span> {globalState.name}</a>
        </div>
